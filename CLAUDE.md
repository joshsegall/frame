...
| `concurrency.rs` | P8 on **interleavings**: does a TUI session and a CLI writer over one project lose work either one acknowledged, drop a track the CLI created, hand an ID out twice, or leave a file unsettled? |
