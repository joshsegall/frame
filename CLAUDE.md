...
| `merge_conservation.rs` | P10 on **three-way merges**: does a merge that reports clean still hold every line either side added since the ancestor — bar a task line it rebuilt from both sides' fields — and does its own audit ever fire? |
